...
\begin{frame}{9. K-Means: Cấu hình \& Kết quả}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.52\textwidth}
            ...
            \textbf{Diễn giải:}
            \begin{itemize}
                \item \textbf{C0 -- Loyal:} Đông nhất, mua thường xuyên.
                \item \textbf{C1 -- At Risk:} R cao, F/M thấp.
                \item \textbf{C2 -- Champions:} F/M cực cao (13 KH).
                \item \textbf{C3 -- High Value:} Mua gần đây, chi nhiều.
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
